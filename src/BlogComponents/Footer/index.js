            ...
            <Row xs="4" className='border-bottom border-2 row1'>
                ...
                <Col >
                    ...
                    <p class="text-start marginBottom" onMouseOver={anim15} onMouseOut={anim16}>
                        ...
                        Abdurazzoqovdavronbek3@gmail.com
            ...
            <Row className='row2'>
                ...
                <Col>
                    <p className='text-center'>
                        <a href='https://www.instagram.com/davronbek.abdurazzokov/'>
                ...
                <Col>
                    <p class="text-end ">@2023 DavronbekAbdurazzokov.com All right reserved.</p>
                </Col>
            </Row>
        </div>
